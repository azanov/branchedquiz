...
class custom_view extends \core_question\bank\view {
    ...
    protected function heading_column() {
        return 'mod_branchedquiz\\question\\bank\\question_name_text_column';
    }

    protected function default_sort() {
        return array(
            'core_question\\bank\\question_type_column' => 1,
            'mod_branchedquiz\\question\\bank\\question_name_text_column' => 1,
        );
    }
    ...
    protected function display_options_form($showquestiontext, $scriptpath = '/mod/mod_branchedquiz/edit.php',
