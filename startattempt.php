...
if (!$cm = get_coursemodule_from_id('branchedquiz', $id)) {
...
list(
    ...
    $lastattempt,
    $messages,
    $page) = quiz_validate_new_attempt($quizobj, $accessmanager, $forcenew, $page, true);
...
if ($accessmanager->is_preflight_check_required($currentattemptid)) {
    ...
    if ($mform->is_cancelled()) {
        $accessmanager->back_to_view_page($PAGE->get_renderer('mod_branchedquiz'));
