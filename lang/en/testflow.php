...
$string['testflowfieldset'] = 'Custom example fieldset';
$string['testflowname'] = 'testflow name';
$string['testflowname_help'] = 'This is the content of the help tooltip associated with the testflowname field. Markdown syntax is supported.';
$string['testflow'] = 'testflow';
$string['pluginadministration'] = 'testflow administration';
$string['pluginname'] = 'testflow';
