...
$string['setasmainquestion'] = 'Set as main path question';
$string['setassubquestion'] = 'Set as sub-question';
$string['typechangedfailed'] = 'Failed to change the question type';
$string['allresults'] = 'All scores';
$string['fixedresult'] = 'Fixed score';
$string['atleast'] = 'At least';
$string['lessthan'] = 'Smaller than';
...
$string['deleteconnection'] = 'Remove connection';